    ...
    <div className={standalone ? 'min-h-screen bg-brand-bg' : 'bg-brand-bg'}>
      ...
      <section className="bg-brand-surface border-b border-brand-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <h1 className="text-4xl font-bold text-brand-text mb-4">Careers</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-brand-surface p-6 rounded-lg border border-brand-border">
              <div className="w-12 h-12 bg-brand-icon-bg rounded-lg flex items-center justify-center mb-4">
                <Award className="text-brand-accent" size={24} />
              </div>
              <h3 className="font-semibold text-brand-text mb-2">Professional Development</h3>
            ...
            <div className="bg-brand-surface p-6 rounded-lg border border-brand-border">
              ...
              <h3 className="font-semibold text-brand-text mb-2">Inclusive Environment</h3>
              <p className="text-sm text-brand-text-muted">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4 max-w-4xl mx-auto">
            {positions.map((position, index) => (
              <div
                key={index}
                className="bg-brand-bg p-6 rounded-lg border border-brand-border hover:border-brand-accent transition-colors"
              >
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap items-center gap-3 mb-3">
                      ...
                      <span className="inline-block px-3 py-1 bg-brand-icon-bg text-brand-accent text-xs font-medium rounded">
                        {position.type}
                      </span>
                    </div>
                    <p className="text-sm text-brand-text-muted">
                  ...
                  <div className="flex-shrink-0">
                    <a
                      href="#application"
                      className="inline-flex items-center px-4 py-2 bg-brand-accent text-white text-sm font-medium rounded hover:bg-brand-accent-hover transition-colors"
                    >
                      Apply
                    </a>
                  </div>
      ...
      <section id="application" className="py-12 bg-brand-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            <div className="bg-brand-surface p-8 rounded-lg border border-brand-border">
                ...
                <div className="flex-1">
                  ...
                  <ul className="space-y-2 mb-6">
                    <li className="flex items-start gap-2">
                      ...
                      <span className="text-brand-text-muted">Current CV or resume</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="w-1.5 h-1.5 bg-brand-accent rounded-full mt-2 flex-shrink-0" />
                      <span className="text-brand-text-muted">Cover letter stating the position you are applying for</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="w-1.5 h-1.5 bg-brand-accent rounded-full mt-2 flex-shrink-0" />
                      <span className="text-brand-text-muted">Brief statement of your relevant qualifications and experience</span>
                    </li>
                  </ul>
              ...
              <div className="border-t border-brand-border pt-6">
                <h3 className="font-semibold text-brand-text mb-3">Application Process</h3>
